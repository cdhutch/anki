#!/usr/bin/env python3
"""Create or update the B737_Table note type in Anki.

Identical to B737_Structured except the back template shows only the
Back field — the front content is not reprinted. Intended for two-column
reference and callout tables where the filled-in table is the answer.
...
Usage:
    python tools/anki/setup/setup_table_model.py
"""
...
# ---------------------------------------------------------------------------
# CSS — identical to B737_Structured
# ---------------------------------------------------------------------------
...
# Back shows only the filled table — front content is not reprinted.
CARD_BACK = """\
{{Back}}
...
# ---------------------------------------------------------------------------
# Helpers (identical to setup_structured_model.py)
# ---------------------------------------------------------------------------
