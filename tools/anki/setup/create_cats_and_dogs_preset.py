#!/usr/bin/env python3
"""Create (or update) the "B737 Cats and Dogs" deck preset and apply it.
...
"B737 Cats and Dogs", that preset is updated in place.

Usage
-----
  python tools/anki/setup/create_cats_and_dogs_preset.py
  python tools/anki/setup/create_cats_and_dogs_preset.py --retention 0.92
"""
...
PRESET_NAME       = "B737 Cats and Dogs"
TARGET_DECKS      = ["B737::Core::Cats_and_Dogs"]
NEW_PER_DAY       = 10
REV_PER_DAY       = 9999
