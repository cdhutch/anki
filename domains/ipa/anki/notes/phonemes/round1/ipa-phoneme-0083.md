...
- status:draft
fields:
  NoteID: ipa-phoneme-0083
  Phoneme: open-mid-front-rounded-vowel-nasalized-french
  IPA_Symbol: œ̃
  Type: vowel
  Description: Open-mid front rounded vowel, nasalized (French)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇫🇷</span><b class="ipa-sound">un</b>
    (a/one)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
