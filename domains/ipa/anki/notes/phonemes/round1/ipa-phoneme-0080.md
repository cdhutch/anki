...
- status:draft
fields:
  NoteID: ipa-phoneme-0080
  Phoneme: open-back-unrounded-vowel-nasalized-french
  IPA_Symbol: ɑ̃
  Type: vowel
  Description: Open back unrounded vowel, nasalized (French)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇫🇷</span>s<b class="ipa-sound">an</b>s
    (without)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
