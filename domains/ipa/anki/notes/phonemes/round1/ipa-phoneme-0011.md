...
- status:draft
fields:
  NoteID: ipa-phoneme-0011
  Phoneme: voiced-palatal-nasal
  IPA_Symbol: ɲ
  Type: consonant
  ...
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-lang">French</span>mo<b>ntagn</b>e
    (mountain)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
