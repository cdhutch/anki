...
- status:draft
fields:
  NoteID: ipa-phoneme-0082
  Phoneme: open-mid-front-unrounded-vowel-nasalized-french
  IPA_Symbol: ɛ̃
  Type: vowel
  Description: Open-mid front unrounded vowel, nasalized (French)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇫🇷</span>p<b class="ipa-sound">ain</b>
    (bread)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
