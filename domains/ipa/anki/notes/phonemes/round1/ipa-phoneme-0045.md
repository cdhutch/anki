...
- status:draft
fields:
  NoteID: ipa-phoneme-0045
  Phoneme: palatalized-voiced-velar-stop-russian
  IPA_Symbol: ɡʲ
  Type: consonant
  Description: Palatalized voiced velar stop (Russian)
  Manner_of_Articulation: stop
  Place_of_Articulation: velar
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇷🇺</span><b class="ipa-sound">г</b>ид
    (guide)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
