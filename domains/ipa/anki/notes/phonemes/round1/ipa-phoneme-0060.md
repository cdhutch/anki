...
- status:draft
fields:
  NoteID: ipa-phoneme-0060
  Phoneme: open-mid-front-unrounded-vowel
  IPA_Symbol: ɛ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: English bed; German Bett (bed); French père (father); Ukrainian це (this)
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
