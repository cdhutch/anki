...
- status:draft
fields:
  NoteID: ipa-phoneme-0044
  Phoneme: palatalized-voiceless-velar-stop-russian
  IPA_Symbol: kʲ
  Type: consonant
  Description: Palatalized voiceless velar stop (Russian)
  Manner_of_Articulation: stop
  Place_of_Articulation: velar
  Voicing: voiceless
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-lang">Russian</span><b>к</b>ино
    (cinema)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
