...
- status:draft
fields:
  NoteID: ipa-phoneme-0078
  Phoneme: close-mid-front-rounded-vowel-short-and-long
  IPA_Symbol: ø / øː
  Type: vowel
  Description: Close-mid front rounded vowel (short and long)
