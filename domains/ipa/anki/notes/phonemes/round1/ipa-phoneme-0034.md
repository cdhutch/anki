...
- status:draft
fields:
  NoteID: ipa-phoneme-0034
  Phoneme: voiced-alveolar-affricate
  IPA_Symbol: dz
  Type: consonant
  ...
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇦</span><b class="ipa-sound">дз</b>він
    (bell)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
