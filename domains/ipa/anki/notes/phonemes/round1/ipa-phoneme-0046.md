...
- status:draft
fields:
  NoteID: ipa-phoneme-0046
  Phoneme: palatalized-voiceless-labiodental-fricative-russian
  IPA_Symbol: fʲ
  Type: consonant
  Description: Palatalized voiceless labiodental fricative (Russian)
  Manner_of_Articulation: fricative
  Place_of_Articulation: labiodental
  Voicing: voiceless
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇷🇺</span><b class="ipa-sound">ф</b>ильм
    (film)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
