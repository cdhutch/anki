...
- status:draft
fields:
  NoteID: ipa-phoneme-0088
  Phoneme: closing-diphthong-open-mid-back-to-close-front-english
  IPA_Symbol: ɔɪ
  Type: diphthong
  Description: Closing diphthong, open-mid back to close front (English)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>b<b class="ipa-sound">oy</b></div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
