...
- status:draft
fields:
  NoteID: ipa-phoneme-0085
  Phoneme: closing-diphthong-mid-back-to-close-back-english
  IPA_Symbol: oʊ
  Type: diphthong
  Description: Closing diphthong, mid back to close back (English)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>g<b class="ipa-sound">o</b></div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
