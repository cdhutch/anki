...
- status:draft
fields:
  NoteID: ipa-phoneme-0064
  Phoneme: near-open-front-unrounded-vowel
  IPA_Symbol: æ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>c<b class="ipa-sound">a</b>t</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
