...
- status:draft
fields:
  NoteID: ipa-phoneme-0071
  Phoneme: open-mid-back-unrounded-vowel
  IPA_Symbol: ʌ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>c<b class="ipa-sound">u</b>p</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
