...
- status:draft
fields:
  NoteID: ipa-phoneme-0067
  Phoneme: open-mid-back-rounded-vowel-long
  IPA_Symbol: ɔː
  Type: vowel
  Description: Open-mid back rounded vowel (long)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span>B<b class="ipa-sound">oo</b>t
    (boat)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
