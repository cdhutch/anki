...
- status:draft
fields:
  NoteID: ipa-phoneme-0022
  Phoneme: voiceless-palatal-fricative
  IPA_Symbol: ç
  Type: consonant
  ...
  Voicing: voiceless
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span><b class="ipa-sound">i</b>ch
    (I)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
