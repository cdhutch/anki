...
- status:draft
fields:
  NoteID: ipa-phoneme-0077
  Phoneme: near-close-near-front-rounded-vowel
  IPA_Symbol: ʏ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span>m<b>ü</b>ssen
    (must)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
