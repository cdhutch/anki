...
- status:draft
fields:
  NoteID: ipa-phoneme-0065
  Phoneme: open-back-unrounded-vowel
  IPA_Symbol: ɑ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>f<b class="ipa-sound">a</b>ther</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
