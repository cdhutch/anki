...
- status:draft
fields:
  NoteID: ipa-phoneme-0073
  Phoneme: near-open-central-vowel
  IPA_Symbol: ɐ
  Type: vowel
  ...
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span>Vat<b class="ipa-sound">er</b>
    (father)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
