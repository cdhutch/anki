...
- status:draft
fields:
  NoteID: ipa-phoneme-0061
  Phoneme: open-mid-front-unrounded-vowel-long
  IPA_Symbol: ɛː
  Type: vowel
  Description: Open-mid front unrounded vowel (long)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span>(contested;
    rare)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
