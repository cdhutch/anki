...
- status:draft
fields:
  NoteID: ipa-phoneme-0049
  Phoneme: palatalized-voiced-bilabial-nasal-russian
  IPA_Symbol: mʲ
  Type: consonant
  Description: Palatalized voiced bilabial nasal (Russian)
  Manner_of_Articulation: nasal
  Place_of_Articulation: bilabial
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇷🇺</span><b class="ipa-sound">м</b>ир
    (world/peace)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
