...
- status:draft
fields:
  NoteID: ipa-phoneme-0048
  Phoneme: palatalized-voiceless-velar-fricative-russian
  IPA_Symbol: xʲ
  Type: consonant
  Description: Palatalized voiceless velar fricative (Russian)
  Manner_of_Articulation: fricative
  Place_of_Articulation: velar
  Voicing: voiceless
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇷🇺</span><b class="ipa-sound">х</b>имия
    (chemistry)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
