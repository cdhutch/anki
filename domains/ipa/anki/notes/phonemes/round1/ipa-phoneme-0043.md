...
- status:draft
fields:
  NoteID: ipa-phoneme-0043
  Phoneme: palatalized-voiced-alveolar-stop
  IPA_Symbol: dʲ
  Type: consonant
  Description: Palatalized voiced alveolar stop
  Manner_of_Articulation: stop
  Place_of_Articulation: alveolar
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇷🇺</span><b class="ipa-sound">д</b>ети
    (children)</div><div class="ipa-example-line"><span class="ipa-flag">🇺🇦</span><b class="ipa-sound">ді</b>ти
    (children)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
