...
- status:draft
fields:
  NoteID: ipa-phoneme-0014
  Phoneme: voiced-labiodental-approximant-ukrainian-в
  IPA_Symbol: ʋ
  Type: consonant
  Description: Voiced labiodental approximant (Ukrainian в)
  Manner_of_Articulation: approximant
  Place_of_Articulation: labiodental
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇦</span><b class="ipa-sound">в</b>ода
    (water)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
