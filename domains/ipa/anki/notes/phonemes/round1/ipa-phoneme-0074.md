...
- status:draft
fields:
  NoteID: ipa-phoneme-0074
  Phoneme: open-mid-central-unrounded-vowel-rhotacized-stressed
  IPA_Symbol: ɝ
  Type: vowel
  Description: Open-mid central unrounded vowel, rhotacized (stressed)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>b<b class="ipa-sound">ir</b>d</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
