...
- status:draft
fields:
  NoteID: ipa-phoneme-0016
  Phoneme: voiced-dental-fricative
  IPA_Symbol: ð
  Type: consonant
  ...
  Voicing: voiced
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span><b class="ipa-sound">th</b>is</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
