...
- status:draft
fields:
  NoteID: ipa-phoneme-0063
  Phoneme: open-front-unrounded-vowel-long
  IPA_Symbol: aː
  Type: vowel
  Description: Open front unrounded vowel (long)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇩🇪</span>V<b>a</b>ter
    (father)</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
