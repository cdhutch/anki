...
- status:draft
fields:
  NoteID: ipa-phoneme-0084
  Phoneme: closing-diphthong-mid-front-to-close-front-english
  IPA_Symbol: eɪ
  Type: diphthong
  Description: Closing diphthong, mid front to close front (English)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-flag">🇺🇸</span>d<b class="ipa-sound">ay</b></div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
