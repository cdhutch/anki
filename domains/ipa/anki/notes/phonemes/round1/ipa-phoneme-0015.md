...
- status:draft
fields:
  NoteID: ipa-phoneme-0015
  Phoneme: voiceless-dental-fricative
  IPA_Symbol: θ
  Type: consonant
  ...
  Voicing: voiceless
  Airflow: ''
  Example_Words: <div class="ipa-example-line"><span class="ipa-lang">English</span><b>th</b>ink</div>
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
