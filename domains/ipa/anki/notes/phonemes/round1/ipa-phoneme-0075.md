...
- status:draft
fields:
  NoteID: ipa-phoneme-0075
  Phoneme: mid-central-vowel-rhotacized-unstressed
  IPA_Symbol: ɚ
  Type: vowel
  Description: Mid central vowel, rhotacized (unstressed)
  Manner_of_Articulation: ''
  Place_of_Articulation: ''
  Voicing: ''
  Airflow: ''
  Example_Words: English letter
  Language_Analogs: ''
  Minimal_Pairs: ''
  Confusable_With: ''
  Mnemonic_EN: ''
