...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to lift, raise (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: піднімати / підняти
  UA_Example: Він піднімає важку валізу.
  EN_Example: He lifts the heavy suitcase.
  Tags_Ch: ch:1.11.5
  Source_URL: https://goroh.pp.ua/Словозміна/піднімати
