...
- status:draft
fields:
  NoteID: ua-lexeme-2304
  Lemma: фотографува́ти
  Lemma_Euphony: ''
  PartOfSpeech: verb
  Gender: ''
  ImperfectiveUnidirectional: ''
  ImperfectiveUnidirectional_Euphony: ''
  Perfective: сфотографува́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to photograph (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: фотографувати / сфотографувати
  UA_Example: Турист фотографує старе місто.
  EN_Example: The tourist photographs the old town.
  Tags_Ch: ch:1.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/фотографувати
