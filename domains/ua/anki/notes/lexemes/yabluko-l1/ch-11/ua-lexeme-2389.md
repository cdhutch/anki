...
fields:
  ...
  Perfective: захова́тися
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to hide (oneself) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: ховатися / заховатися
  UA_Example: Діти ховаються під час гри.
  EN_Example: The children hide during the game.
  Tags_Ch: ch:1.11.3
  Source_URL: https://goroh.pp.ua/Словозміна/ховатися
