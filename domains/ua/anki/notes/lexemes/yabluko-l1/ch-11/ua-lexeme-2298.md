...
fields:
  ...
  Perfective: закі́нчити
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to finish, end (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: закінчувати / закінчити
  UA_Example: Я закінчую роботу о шостій.
  EN_Example: I finish work at six.
  Tags_Ch: ch:1.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/закінчувати
