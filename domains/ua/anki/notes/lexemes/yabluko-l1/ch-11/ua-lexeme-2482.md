...
fields:
  ...
  Perfective: покерува́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to drive, operate (a vehicle) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: керувати / покерувати
  UA_Example: Він керує машиною обережно.
  EN_Example: He drives the car carefully.
  Tags_Ch: ch:1.11.5
  Source_URL: https://goroh.pp.ua/Словозміна/керувати
