...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to begin, start (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: починати / почати
  UA_Example: Урок починається о дев''ятій.
  EN_Example: The lesson begins at nine.
  Tags_Ch: ch:1.11.2
  Source_URL: https://goroh.pp.ua/Словозміна/починати
