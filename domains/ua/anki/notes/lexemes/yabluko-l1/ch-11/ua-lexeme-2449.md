...
fields:
  ...
  Perfective: переста́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to stop, cease (doing something) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: переставати / перестати
  UA_Example: Дощ перестає йти.
  EN_Example: The rain is stopping.
  Tags_Ch: ch:1.11.4
  Source_URL: https://goroh.pp.ua/Словозміна/переставати
