...
fields:
  ...
  Perfective: показа́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to show (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: показувати / показати
  UA_Example: Вона показує гостям квартиру.
  EN_Example: She shows the guests the apartment.
  Tags_Ch: ch:1.11.2
  Source_URL: https://goroh.pp.ua/Словозміна/показувати
