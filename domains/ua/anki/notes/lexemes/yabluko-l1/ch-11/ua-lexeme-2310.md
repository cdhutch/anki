...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to say, tell (perfective)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: каза́ти (ua-lexeme-0317, imperfective)
  VerbMotion_Pair: ''
  ConfusableSet: ''
  Mnemonic_EN: ''
  CrossLang_Analog: ''
