...
fields:
  ...
  Perfective: загада́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to make (a wish) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: загадувати / загадати
  UA_Example: Вона загадує бажання на день народження.
  EN_Example: She makes a wish on her birthday.
  Tags_Ch: ch:1.11.5
  Source_URL: https://goroh.pp.ua/Словозміна/загадувати
