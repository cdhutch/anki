...
fields:
  ...
  Perfective: пози́чити
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to lend; to borrow (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: позичати / позичити
  UA_Example: Він позичає книжку в бібліотеці.
  EN_Example: He borrows a book from the library.
  Tags_Ch: ch:1.11.5
  Source_URL: https://goroh.pp.ua/Словозміна/позичати
