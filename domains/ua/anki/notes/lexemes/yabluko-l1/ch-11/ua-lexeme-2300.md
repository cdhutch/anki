...
fields:
  ...
  Perfective: зупини́тися
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to stop (oneself) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: зупинятися / зупинитися
  UA_Example: Автобус зупиняється на кожній зупинці.
  EN_Example: The bus stops at every stop.
  Tags_Ch: ch:1.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/зупинятися
