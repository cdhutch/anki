...
fields:
  ...
  Perfective: включи́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to include; to turn on (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: включати / включити
  UA_Example: Ціна включає сніданок.
  EN_Example: The price includes breakfast.
  Tags_Ch: ch:1.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/включати
