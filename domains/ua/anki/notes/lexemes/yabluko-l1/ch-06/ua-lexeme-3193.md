...
- release:pending
fields:
  NoteID: ua-lexeme-3193
  Lemma: зді́йснюватися
  Lemma_Euphony: ''
  PartOfSpeech: verb
  Gender: null
  ImperfectiveUnidirectional: ''
  ImperfectiveUnidirectional_Euphony: ''
  Perfective: здійсни́тися
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to come true, be realized (of a dream) (imperfective)
  Govt_Case: ''
  IrregularForms: ''
  ...
  Verification Notes: New (yabluko-l1 vocabulary expansion pass, 2026-08-29). Perfective здійсни́тися
