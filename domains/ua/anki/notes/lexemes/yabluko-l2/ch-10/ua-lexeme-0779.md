...
fields:
  ...
  Perfective: зну́ди́ти
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: 'to feel nauseous (impersonal: мене нудить = ''I feel sick'')'
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Verification Notes: New. Горох gives a full personal paradigm for this verb, but in the
