...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to do, to make (perfective)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  UA_Example: Мені треба зробити аналізи крові.
  EN_Example: I need to have blood tests done.
  Tags_Ch: ch:2.10.6
