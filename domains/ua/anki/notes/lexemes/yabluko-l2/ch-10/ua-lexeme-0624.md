...
fields:
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: реєстрація
  UA_Example: Реєстрація на рейс триває дві години.
  EN_Example: Check-in for the flight lasts two hours.
  Tags_Ch: ch:2.10.1
  Source_URL: https://goroh.pp.ua/Словозміна/реєстрація
