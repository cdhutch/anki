...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to baptize, to christen
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Verification Notes: New. Горох marks this verb 'двовидове' (biaspectual) -- the same form
    serves as both perfective and imperfective depending on context, though Горох also separately
    lists a purely-imperfective conjugation table (2nd conjugation, 1sg хрещу́ with the consonant
    mutation т→щ). Drafted with Aspect left as 'biaspectual' on the paired ua-verb-0119 note
