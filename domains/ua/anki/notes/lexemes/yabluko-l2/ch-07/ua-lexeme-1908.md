...
fields:
  ...
  CrossLang_Analog: ''
  TypingAnswer: сервіс
  UA_Example: Цей сервіс вимагає окремої реєстрації.
  EN_Example: This service requires a separate registration.
  Tags_Ch: ch:2.7.2
  Source_URL: https://goroh.pp.ua/Словозміна/сервіс
