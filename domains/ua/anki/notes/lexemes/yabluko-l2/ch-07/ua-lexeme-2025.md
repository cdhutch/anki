...
fields:
  ...
  CrossLang_Analog: ''
  TypingAnswer: блютуз
  UA_Example: Навушники підключаються через блютуз.
  EN_Example: The headphones connect via bluetooth.
  Tags_Ch: ch:2.7.5
  Source_URL: https://goroh.pp.ua/Словозміна/блютуз
  ...
  Verification Notes: New. Masc., inanimate, 2nd decl., hard group, loanword.
---
