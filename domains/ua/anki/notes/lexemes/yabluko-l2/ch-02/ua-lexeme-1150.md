...
fields:
  ...
  Source_Note: Горох-verified 2026-08-28, ch.2.7 sourcing pass (invitations/exhibitions, formal
    letters).
  Verification Notes: New. Compound proper noun (adjective + noun). Bundles тихий (ua-lexeme-1139,
    this chapter) and океан (ua-lexeme-0172, retagged ch:2.7 this pass).
---
