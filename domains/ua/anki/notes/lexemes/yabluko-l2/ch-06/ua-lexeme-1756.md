...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to look after, care for, tend to (imperfective)
  Govt_Case: за + Ор.
  IrregularForms: ''
  CounterpartForm: догля́нути (ua-lexeme-1757, perfective)
  VerbMotion_Pair: ''
  ConfusableSet: ''
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  ...
  Verification Notes: New. Imperfective, "to look after, care for". Textbook aspect pair доглядати-доглянути,
    this sub-chapter.
---
