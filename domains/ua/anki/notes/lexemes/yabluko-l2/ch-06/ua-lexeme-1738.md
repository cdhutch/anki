...
fields:
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: підтримка
  UA_Example: Дякую за підтримку в цей важкий час.
  EN_Example: Thank you for your support during this hard time.
  Tags_Ch: ch:2.6.3
  Source_URL: https://goroh.pp.ua/Словозміна/підтримка
