...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to tidy up, clean (imperfective)
  Govt_Case: Зн.
  IrregularForms: ''
  CounterpartForm: прибра́ти (ua-lexeme-1674, perfective)
  VerbMotion_Pair: ''
  ConfusableSet: ''
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  ...
  Verification Notes: New. Imperfective, "to tidy up, clean". Textbook aspect pair прибирати-прибрати,
    this sub-chapter.
---
