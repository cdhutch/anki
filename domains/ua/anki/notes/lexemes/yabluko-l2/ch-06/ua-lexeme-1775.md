...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to end up (somewhere); (потрапити під арешт) to get arrested (perfective)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: потрапля́ти (ua-lexeme-1087, imperfective)
  VerbMotion_Pair: ''
  ConfusableSet: ''
  Mnemonic_EN: ''
  CrossLang_Analog: ''
