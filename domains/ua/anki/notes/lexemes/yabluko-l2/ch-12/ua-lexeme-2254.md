...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: singular (grammatical number)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  CrossLang_Analog: ''
  TypingAnswer: однина
  UA_Example: Слово 'книга' стоїть в однині.
  EN_Example: The word 'book' is in the singular.
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/однина
  ...
  Verification Notes: New. Fem., 1st decl., hard group. Grammar-terminology noun; множина
    ('plural') not separately drafted here.
---
