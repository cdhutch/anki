...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: adjective (grammatical term)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: прикметник
  UA_Example: '''Гарний'' -- це прикметник.'
  EN_Example: '''Beautiful'' is an adjective.'
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/прикметник
