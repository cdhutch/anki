...
fields:
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: напамʼять
  UA_Example: Учні мають вивчити вірш напамʼять.
  EN_Example: The students must learn the poem by heart.
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/напамʼять
  ...
  Verification Notes: New. Manner adverb, indeclinable, apostrophe before я after п.
---
