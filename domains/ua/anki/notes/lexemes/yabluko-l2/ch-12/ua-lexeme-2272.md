...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: radically, fundamentally
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: кардинально
  UA_Example: Ситуація кардинально змінилася за рік.
  EN_Example: The situation changed radically in a year.
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/кардинально
  ...
  Verification Notes: New. Regular adverb from кардинальний.
---
