...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: adverb (grammatical term)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: прислівник
  UA_Example: '''Швидко'' -- це прислівник.'
  EN_Example: '''Quickly'' is an adverb.'
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/присловник
