...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to be afraid, to fear (perfective)
  Govt_Case: Р.
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  UA_Example: Він не побоявся сказати правду.
  EN_Example: He wasn't afraid to tell the truth.
  Tags_Ch: ch:2.12.1
  ...
  Verification Notes: New. pf. partner of боятися (ua-lexeme-2184/ua-verb-0587), по- prefix,
    same irregular conjugation.
---
