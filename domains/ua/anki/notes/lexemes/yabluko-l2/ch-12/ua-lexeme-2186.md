...
fields:
  ...
  Perfective: розізли́тися
  Perfective_Euphony: ''
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to be angry, get angry (imperfective)
  Govt_Case: на + Зн.
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: злитися / розізлитися
  UA_Example: Не злися на мене, будь ласка.
  EN_Example: Don't be angry with me, please.
  Tags_Ch: ch:2.12.1
  Source_URL: https://goroh.pp.ua/Словозміна/злитися
