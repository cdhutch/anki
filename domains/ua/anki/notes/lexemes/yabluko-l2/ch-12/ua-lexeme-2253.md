...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: noun (grammatical term)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: іменник
  UA_Example: Кожен іменник має рід, число і відмінок.
  EN_Example: Every noun has gender, number, and case.
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/іменник
  ...
  Verification Notes: New. Masc., 2nd decl., hard group. Grammar-terminology noun.
---
