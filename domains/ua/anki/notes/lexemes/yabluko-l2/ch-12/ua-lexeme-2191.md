...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: scarily; it's scary / I feel scared
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: страшно
  UA_Example: Мені страшно самому вночі.
  EN_Example: I'm scared being alone at night.
  Tags_Ch: ch:2.12.1
  Source_URL: https://goroh.pp.ua/Словозміна/страшно
  ...
  Verification Notes: New. Impersonal-predicate adverb (Мені + adverb construction), same
    pattern as нудно/цікаво/весело.
---
