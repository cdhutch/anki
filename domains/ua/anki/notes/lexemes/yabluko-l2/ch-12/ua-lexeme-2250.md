...
- status:draft
fields:
  NoteID: ua-lexeme-2250
  Lemma: дієсло́во
  Lemma_Euphony: ''
  PartOfSpeech: noun
  Gender: n., 2nd decl., hard group
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: verb (grammatical term)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: дієслово
  UA_Example: Дієслово змінюється за особами й часами.
  EN_Example: A verb changes according to person and tense.
  Tags_Ch: ch:2.12.7
  Source_URL: https://goroh.pp.ua/Словозміна/дієслово
  ...
  Verification Notes: New. Neut., 2nd decl., hard group. Grammar-terminology noun.
---
