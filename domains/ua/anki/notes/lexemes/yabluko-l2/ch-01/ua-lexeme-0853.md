...
fields:
  ...
  Source_Note: Горох-verified 2026-08-28, ch.1.3 sourcing pass (time/weather/profession; opinion
    & routine verbs).
  Verification Notes: New. Fem., 1st decl., hard group. This is the "одиниця часу" (unit of
    time) sense specifically. Горох also lists an unrelated homograph sense "гарна погода"
    (fine/nice weather, colloquial) -- not drafted, no sibling note.
---
