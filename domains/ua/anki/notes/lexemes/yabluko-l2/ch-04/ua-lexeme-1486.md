...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to come to a conclusion/thought
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: дійти думки
  UA_Example: Урешті-решт вони дійшли думки, що варто спробувати ще раз.
  EN_Example: In the end, they came to the thought that it was worth trying again.
  Tags_Ch: ch:2.4.5
  Source_URL: https://goroh.pp.ua/Словозміна/думки
