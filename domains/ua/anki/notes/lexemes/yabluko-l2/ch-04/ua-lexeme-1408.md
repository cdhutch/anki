...
- status:draft
fields:
  NoteID: ua-lexeme-1408
  Lemma: незалежна держава
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: незалежна держава
  UA_Example: У тисяча девʼятсот девʼяносто першому році Україна стала незалежною державою.
  EN_Example: In nineteen ninety-one, Ukraine became an independent state.
  Tags_Ch: ch:2.4.3
