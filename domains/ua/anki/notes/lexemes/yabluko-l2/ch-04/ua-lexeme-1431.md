...
- release:pending
fields:
  NoteID: ua-lexeme-1431
  Lemma: за кілька тижнів до…
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: за кілька тижнів до…
  UA_Example: За кілька тижнів до весілля вони переїхали в нову квартиру.
  EN_Example: A few weeks before the wedding, they moved into a new apartment.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/до…
