...
fields:
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: на початку
  UA_Example: На початку двадцятого століття тут було село.
  EN_Example: At the beginning of the twentieth century, there was a village here.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/початку
