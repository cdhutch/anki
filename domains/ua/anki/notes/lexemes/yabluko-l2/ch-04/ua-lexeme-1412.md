...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: the death penalty, capital punishment
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: смертна кара
  UA_Example: У цій країні смертну кару скасували десятиліття тому.
  EN_Example: In this country, the death penalty was abolished decades ago.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/кара
