...
- status:draft
fields:
  NoteID: ua-lexeme-1415
  Lemma: найнятися працювати
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to get hired to work, take a job
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: найнятися працювати
  UA_Example: Він найнявся працювати на будівництві.
  EN_Example: He got hired to work in construction.
  Tags_Ch: ch:2.4.3
