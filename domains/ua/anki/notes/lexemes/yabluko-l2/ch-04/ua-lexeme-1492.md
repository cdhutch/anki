...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: hardworking, industrious
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Source_Note: Горох-verified 2026-08-28, ch.4.5 sourcing pass (upbringing/community/generations;
    character traits).
  Verification Notes: New. Hard-group adjective. Stress працьови́тий (fixed across forms per
    Горох).
---
