...
- status:draft
fields:
  NoteID: ua-lexeme-1430
  Lemma: у другій половині
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: in the second half (of a period)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: у другій половині
  UA_Example: У другій половині століття країна швидко відновлювалася.
  EN_Example: In the second half of the century, the country recovered quickly.
  Tags_Ch: ch:2.4.3
