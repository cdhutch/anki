...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: earlier, before, previously
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  CrossLang_Analog: ''
  TypingAnswer: раніше
  UA_Example: Раніше тут стояв старий замок.
  EN_Example: Earlier, an old castle stood here.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/раніше
