...
- status:draft
fields:
  NoteID: ua-lexeme-1407
  Lemma: невдала спроба
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: невдала спроба
  UA_Example: Це була вже друга невдала спроба втечі.
  EN_Example: It was already the second failed escape attempt.
  Tags_Ch: ch:2.4.3
