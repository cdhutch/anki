...
- status:draft
fields:
  NoteID: ua-lexeme-1406
  Lemma: масові депортації
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: масові депортації
  UA_Example: Масові депортації змусили тисячі людей покинути домівки.
  EN_Example: Mass deportations forced thousands of people to leave their homes.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/депортації
