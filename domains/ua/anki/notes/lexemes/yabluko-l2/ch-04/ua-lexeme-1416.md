...
- status:draft
fields:
  NoteID: ua-lexeme-1416
  Lemma: отримати добру освіту
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: to get a good education
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: отримати добру освіту
  UA_Example: Батьки хотіли, щоб діти отримали добру освіту.
  EN_Example: The parents wanted their children to get a good education.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/освіту
