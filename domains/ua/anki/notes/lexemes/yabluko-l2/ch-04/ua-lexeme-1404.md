...
- release:pending
fields:
  NoteID: ua-lexeme-1404
  Lemma: жорстока дисципліна
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: harsh/cruel discipline (regime)
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: жорстока дисципліна
  UA_Example: У таборі панувала жорстока дисципліна.
  EN_Example: Harsh discipline prevailed in the camp.
  Tags_Ch: ch:2.4.3
  Source_URL: https://goroh.pp.ua/Словозміна/дисципліна
