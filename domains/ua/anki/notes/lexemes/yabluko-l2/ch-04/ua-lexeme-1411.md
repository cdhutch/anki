...
- release:pending
fields:
  NoteID: ua-lexeme-1411
  Lemma: переміщена особа
  Lemma_Euphony: ''
  PartOfSpeech: phrase
  Gender: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: переміщена особа
  UA_Example: Після війни багато переміщених осіб не могли повернутися додому.
  EN_Example: After the war, many displaced persons could not return home.
  Tags_Ch: ch:2.4.3
