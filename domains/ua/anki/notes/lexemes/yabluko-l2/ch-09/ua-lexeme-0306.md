...
fields:
  ...
  ConfusableSet: 'вид (ua-lexeme-0143, kind/type sense) -- convergent synonym, not a homograph:
    ...
    sense ("тип у систематиці: вид, категорія, різновид, форма"). Both mean "kind, type" with
    real overlap, but this corpus''s attested collocations lean different directions: тип
    pairs with vehicles/documents/mechanisms (тип вагона, тип пристрою -- per this note''s
  ...
  Verification Notes: 'Monosyllabic -- no stress mark. Горох''s homograph sense ''про людину''
    (a type of person) not relevant here. 2026-07-30 Craig: flagged as confusable with вид
    (similar EN meanings). Built a bucket-4 Shape 2 confusables Compare card cross-linking
    ua-lexeme-0143 (вид, kind/type sense) -- confirmed via Горох''s Синонімія page for тип,
    which lists вид among its synonyms. Note: ua-lexeme-0143 is already in Shape 1 homograph-disambiguation
    mode (paired with ua-lexeme-0182, the grammatical-aspect sense of вид) -- deliberately
    did NOT rewire 0143''s own CompareA/B/Homograph_SenseA/B to accommodate тип, since that
    would break its existing working homograph card and mix two incompatible Compare-card
