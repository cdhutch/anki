...
fields:
  ...
  ConfusableSet: ''
  Mnemonic_EN: ї́здити = "travels/goes by vehicle habitually, no set direction" (multidirectional
  ...
  Tags_Ch: ch:2.9.4, ch:1.3.3, ch:1.4.1, ch:1.5.5, ch:1.8.5
  ...
  Verification Notes: 'Stress marks for all three aspect slots confirmed via Горох Словозміна:
    ї́здити (multi, impf.), ї́хати (uni, impf.), пої́хати (perf.) -- no homograph ambiguity
    on any of the three pages (unlike піти in the ходити group). New note; no prior lexeme
