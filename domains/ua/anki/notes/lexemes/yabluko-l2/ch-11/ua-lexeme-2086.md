...
fields:
  ...
  EuphonyNote: ''
  AspectCue: ''
  EN_Gloss: enterprise, business, factory
  Govt_Case: ''
  IrregularForms: ''
  CounterpartForm: ''
  VerbMotion_Pair: ''
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: підприємство
  UA_Example: Це підприємство викидає забруднюючі речовини в повітря.
  EN_Example: This enterprise releases pollutants into the air.
  Tags_Ch: ch:2.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/підприємство
