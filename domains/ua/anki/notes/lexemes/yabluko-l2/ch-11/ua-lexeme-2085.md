...
fields:
  ...
  Mnemonic_EN: ''
  CrossLang_Analog: ''
  TypingAnswer: надмірне забруднення
  UA_Example: Надмірне забруднення повітря шкодить здоровʼю.
  EN_Example: Excessive air pollution harms health.
  Tags_Ch: ch:2.11.1
  Source_URL: https://goroh.pp.ua/Словозміна/надмірне забруднення
