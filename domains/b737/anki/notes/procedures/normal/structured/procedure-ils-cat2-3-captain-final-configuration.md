...
domain: b737
note_type: procedure
note_id: procedure-ils-cat2-3-captain-final-configuration
anki:
...
fields:
  ...
  Source Location: Approach Procedures 10.5.1 — ILS CAT II/III Actions & Callouts
...
What are the Captain (PF) actions from the Final Approach Verification Altitude Fix through final landing configuration on an ILS CAT II/III?
...
*Next: ILS CAT II/III — First Officer (PM) — Final Configuration*