...
powered_by: ''
interacts_with: ''
notes: 'Reliability concept: 2 TRs can carry total connected DC load (3rd provides redundancy
  margin).'
---
...
How many TRs are required to supply the total connected load?
