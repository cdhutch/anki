...
note_id: cat-bleed-transition-prepushback-to-l-engine-taxi
anki:
...
Pre-pushback → Taxiing on L engine: what switch changes are made?
...
| --------      | ------   | ----         |
| ISO Valve     | OPEN     | AUTO         |
| Packs         | Both OFF | Both AUTO    |
| Engine Bleeds | Both ON  | L OFF / R ON |
