...
fields:
  ...
  Original Note ID: autoflight-41
  Original Prompt Style: cloze
  Original Text: 'In LNAV, the AFDS intercepts and tracks the active FMC route if {{c1::the
  ...
  Choice A: ''
  Choice B: 'The criteria for either 1 or 2 above are met: on any heading and within 3 NM
