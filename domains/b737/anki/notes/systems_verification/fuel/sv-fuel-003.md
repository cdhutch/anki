...
fields:
  ...
  Original Note ID: fuel-003
  Original Prompt Style: cloze
  Original Text: At the moment this *(Engine 1 Forward Fuel Pump)* Low Pressure light illuminated,
    which of the following statements is also true? {{c1::The Center Tank Scavenge Jet Pump
