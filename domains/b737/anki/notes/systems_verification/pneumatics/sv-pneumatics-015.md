...
fields:
  ...
  Original Note ID: pneumatics-015
  Original Prompt Style: cloze
  Original Text: 'In a situation with the left WING-BODY OVERHEAT illuminated, the QRH directs
    the crew to close the isolation valve, turn off the pack, close the engine bleed on the
    affected side, and turn off the wing anti-ice. Accomplishing these procedures will {{c1::prevent
