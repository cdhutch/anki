...
fields:
  ...
  Original Note ID: electrical-009
  Original Prompt Style: cloze
  Original Text: 'In-flight, engine #1 experiences a loss of all thrust as shown on the Upper
    Display Unit above. This situation would also be accompanied by which of the following
    electrical system lights on the overhead panel. {{c1::# 1 SOURCE OFF, DRIVE lights and
    #1 GEN OFF BUS}}'
